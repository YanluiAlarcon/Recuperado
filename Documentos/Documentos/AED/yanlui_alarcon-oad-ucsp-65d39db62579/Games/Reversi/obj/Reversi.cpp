//#include <adoctint.h>
// Created by yanlu on 11/19/2015.
//
/*
#include "Reversi.h"
#include <iostream>
...
void Reversi::print(int mat1){
    for(int i = 0 ; i < colum ; ++i){
        int mat1[i] = new mat1[row];
        for(int j = 0 ; j < row ; ++j){
            cout << mat[i][j] << " ";
        }
        cout << endl;
...
Reversi::Reversi() : GridGame(GAME_REVERSI, "Reversi") {
    m_playerSymbols = "XO";
...
Reversi::Reversi(const char *playerSymbols) : GridGame(GAME_REVERSI, "Reversi") {
